...
export const addAnalyzeDomainPatters = (mcp) => (session) => {
    mcp.addTool({
...
const sampleIndustry = (sample) => (domain) => async (context) => {
...
const samplePatterns = (sample) => async (industryAnalysis) => {
    // Step 1: Sample industry knowledge about the domain
...
const sampleGuidance = (sample) => (domain) => async (operationPatterns) => {
    // Step 1: Sample industry knowledge about the domain
...
const sampleRecommendations = (sample) => (industryAnalysis) => (architecturalGuidance) => async (operationPatterns) => {
    // Step 1: Sample industry knowledge about the domain
