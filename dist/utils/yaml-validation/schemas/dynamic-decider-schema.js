...
export const StateShapeBaseSchema = Type.Record(Type.String(), TypeNotationSchema);
...
export const DataShapeSchema = Type.Record(Type.String(), Type.Union([
    TypeNotationSchema,
    Type.Record(Type.String(), TypeNotationSchema)
]));
export const MetadataShapeSchema = Type.Record(Type.String(), TypeNotationSchema);
...
export function createDynamicStateShapeSchema(states) {
    const properties = {
...
export function createDeciderSchema(states) {
    ...
    return Type.Object({
        ...
        command_shapes: Type.Record(Type.String({ pattern: '^[a-z][a-z-]*$' }), CommandShapeSchema),
        event_shapes: Type.Record(Type.String({ pattern: '^[a-z][a-z-]*$' }), EventShapeSchema)
    });
}
