...
export const generateRequirementsPrompt = async (args) => {
    const { yaml_content } = args;
    const systemPrompt = `You are a business analyst expert at converting lifecycle.yaml specifications into user stories and requirements.
...
- Include acceptance criteria from the preconditions
