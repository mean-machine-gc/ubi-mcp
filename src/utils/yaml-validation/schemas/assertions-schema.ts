...
export const GuardDefinitionSchema = Type.Record(
  Type.String({ pattern: '^[a-z][a-z_]*$' }),
  Type.String({ minLength: 5 })
);

export const PreconditionDefinitionSchema = Type.Record(
  Type.String({ pattern: '^[a-z][a-z_]*$' }),
  Type.String({ minLength: 5 })
);

export const BranchingConditionSchema = Type.Record(
  Type.String(),
...
export const OutcomeAssertionsSchema = Type.Record(
  Type.String({ pattern: '^[a-z][a-z_]*$' }),
...
export type AssertionsSpec = Static<typeof AssertionsSchema>;