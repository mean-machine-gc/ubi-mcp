...
export const AssertionsSchema = Type.Object({
  ...
  branching_conditions: Type.Record(
    Type.String({
  ...
  outcome_assertions: Type.Record(
    Type.String({
 ...
 */
export type LifecycleBranch = Static<typeof LifecycleBranchSchema>;
export type LifecycleOperation = Static<typeof LifecycleOperationSchema>;
export type Lifecycle = Static<typeof LifecycleSchema>;
export type OutcomeAssertion = Static<typeof OutcomeAssertionSchema>;
 ...
 */
export function validateLifecycle(data: unknown): ValidationResult {
  try {
 ...
 */
export function validateAssertions(data: unknown): ValidationResult {
  try {
    // Note: In actual implementation, you'd use TypeBox's Value.Check or similar
    const isValid = true; // TypeBox validation would go here
...
export function validateCrossReferences(
  ...
  const allBranchingConditions = new Set<string>();
  const allOutcomeAssertions = new Set<string>();
