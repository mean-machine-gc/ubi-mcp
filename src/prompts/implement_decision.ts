...
export const implementDecisionPrompt = async (args: {domain?: string, operation?: string, types?: string, events?: string, lifecycle_yaml?: string}): Promise<GetPromptResult> => {
