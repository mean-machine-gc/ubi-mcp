...
/**
 * Pattern for synthetic tool descriptions:
 * 1. What it does (one clear sentence)
 * 2. When to use it (specific triggers)
 * 3. What you get (concrete outcomes)
 * 4. Simple input/output
 */
type SyntheticToolDescription = {
    name: string,
    description: string,
    when_to_use: string[],
    what_you_get: string[],
...
export const syntheticToolDescriptions: Record<string, SyntheticToolDescription> = {
 ...
 */
export function generateToolUsageDoc(toolName: string): string {
