...
export const addBuilsOperationIncrementally = (mcp: FastMCP) => (session: FastMCPSession): void => {
    mcp.addTool(
          {
            ...
            parameters: z.object({
              ...
              existing_operations: z.array(
                z.string()
              ).describe(`List of existing operations in this aggregate`)
            }),
            execute: async (args) => {
                 const { 
                        operation_name, 
...
const sampleAnalysis = 
    ...
    (operation_name: any) =>
    (operation_description: any) =>
    (domain_context: any) =>
    async (existing_operations: string[]) => {
...
const sampleBranching = 
    (sample: (userPrompt: string) => Promise<unknown>) => 
    (operation_name: any) =>
    (operationAnalysis: any) =>
    async (preconditionsAnalysis: any) => {
...
const sampleSpecifications = 
    ...
    (preconditionsAnalysis: any) =>
    async (branchingAnalysis: any) => {
